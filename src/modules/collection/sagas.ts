...
import { FetchTransactionSuccessAction, FETCH_TRANSACTION_SUCCESS } from 'unicial-dapps/dist/modules/transaction/actions'
import { Provider, Wallet } from 'unicial-dapps/dist/modules/wallet/types'
...
import { getChainIdByNetwork, getNetworkProvider } from 'unicial-dapps/dist/lib/eth'
...
export function* collectionSaga(legacyBuilderClient: BuilderAPI, client: BuilderClient, catalyst: CatalystClient) {
  ...
  function* handleInitiateTPItemsApprovalFlow(action: InitiateTPApprovalFlowAction) {
    ...
    try {
      ...
      // TODO: Use the builder client. Tracked here: https://github.com/unicial/builder/issues/1855
