...
import { getProfileOfAddress } from 'unicial-dapps/dist/modules/profile/selectors'
import { Profile } from 'unicial-dapps/dist/modules/profile/types'
...
describe('when setting a new curation assignee successfully', () => {
  ...
  beforeEach(() => {
    mockedCollection = {
      id: 'anId',
      forumLink: 'https://forum.unicial.org/t/collection-cucos-created-by-MrCuco-is-ready-for-review/10713'
    } as Collection
    mockedCuration = {
      id: 'curationId',
