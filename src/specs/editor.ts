...
export const wearable: Wearable = {
  ...
  type: 'wearable',
  category: 'eyewear',
  baseUrl: 'https://peer-ec1.unicial.org/content/contents/',
...
export const catalystWearable: CatalystWearable = {
  id: 'urn:decentraland:off-chain:base-avatars:aviatorstyle',
  description: '',
  thumbnail: 'https://peer-ec1.unicial.org/content/contents/QmWEr5ttPDezxMjDHU1UKPPukHjLiNEi1EjznmaUXiaHgn',
  rarity: '',
  data: {
    tags: ['accesories', 'male', 'man', 'base-wearable'],
        ...
        contents: [
          {
            ...
            url: 'https://peer-ec1.unicial.org/content/contents/QmYktkLr5rnn9zPPARkavhVowvTNTih8uWq8BVscTGxtZD'
          },
          {
            key: 'M_Eyewear_AviatorStyle.glb',
            url: 'https://peer-ec1.unicial.org/content/contents/QmXb4PnGmkpTLEfbrFrkupXjxj1AafyEX3k53iFnjsSmAk'
          }
        ]
      }
    ]
