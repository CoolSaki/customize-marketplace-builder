...
import { Loader, Dropdown, Button } from 'unicial-ui'
                ...
                <>
                  ...
                  <Collapsable item={item} label={t('item_editor.right_panel.details')}>
                    {item => (
                      <div className="details">
                        {canEditItemMetadata ? (
                          <>
                            <div className="edit-item-file-wrapper">
                              <Icon name="edit" onClick={this.handleChangeItemFile} />
                            </div>
                            {downloadButton}
                  ...
                  {isDirty ? (
                    <div className="edit-buttons">
                      <Button inverted onClick={this.handleOnResetItem}>
                        {t('global.cancel')}
                      </Button>
