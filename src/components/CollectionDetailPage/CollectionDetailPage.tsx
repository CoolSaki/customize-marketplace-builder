...
import { Section, Row, Narrow, Column, Header, Button, Icon, Popup, Radio, CheckboxProps } from 'unicial-ui'
import { NetworkCheck } from 'unicial-dapps/dist/containers'
                  ...
                  <Row className="actions">
                    {collection.isPublished ? (
                      <>
                        ...
                        <Button inverted className="action-button" disabled={!canMint} onClick={this.handleMintItems}>
                          <Icon name="paper plane" />
                          <span className="text">{t('collection_detail_page.mint_items')}</span>
                        </Button>
                      </>
                    ) : (
                      <Button inverted className="action-button" disabled={isLocked} onClick={this.handleNewItem}>
                        <Icon name="plus" />
