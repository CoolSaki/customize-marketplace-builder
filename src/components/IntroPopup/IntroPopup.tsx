...
import { Button, Column, Header, Popup } from 'unicial-ui'
              ...
              <p className="content">
                <T
                  ...
                  values={{
                    ...
                    blog_link: (
                      <a href="https://unicial.org/blog/announcements/polygon-mana/" target="_blank" rel="noopener noreferrer">
                        {t('intro_popup.blog_link')}
                      </a>
                    ),
                    account_link: (
                      <a
                        href={env.get('REACT_APP_ACCOUNT_URL', 'https://account.unicial.org')}
                        target="_blank"
