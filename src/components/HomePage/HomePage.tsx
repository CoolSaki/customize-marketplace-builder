...
import { Container, Button, Page, Dropdown, DropdownProps, Pagination, PaginationProps, Row, Header, Icon, Section } from 'unicial-ui'
...
export default class HomePage extends React.PureComponent<Props> {
  ...
  renderImportButton = () => {
    return (
      <Button inverted className="import-scene" onClick={this.handleOpenImportModal}>
  ...
  renderCreateButton = () => {
    return (
      <Button inverted className="create-scene" onClick={this.handleOpenCreateModal}>
        <BuilderIcon name="add" />
      </Button>
    )
  }
          ...
          <div>
            <T
              ...
              values={{
                br: <br />,
                sign_in: (
                  <a href="#" className="click-btn" onClick={this.handleLogin}>
                    {t('user_menu.sign_in')}
                  </a>
                )
              }}
                ...
                <Row>
                  ...
                  <Row align="right">
                    <Link to={locations.poolSearch()}>
                      <Button basic className="view-more">
