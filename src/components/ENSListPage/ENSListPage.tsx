...
import { Popup, Button, Table, Row, Column, Header, Section, Container, Pagination, Dropdown, Empty } from 'unicial-ui'
              ...
              <Column align="right" grow={false} shrink>
                <Row>
                  <div className="actions">
                    <Button inverted onClick={this.handleClaimENS}>
                      <Icon name="add" />
                    </Button>
                  </div>
                </Row>
          ...
          <Section className="table-section">
            {ensList.length > 0 ? (
              ...
              <Empty className="empty-names" height={200}>
                <div className="empty-names-container">
                  <T
