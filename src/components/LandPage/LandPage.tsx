...
import { Table, Row, Radio, Column, Header, Pagination, Section, Container, Popup } from 'unicial-ui'
              ...
              <Column align="right">
                <Row>
                  ...
                  <MultiSelect
                    ...
                    onClick={() => onSetView(LandPageView.GRID)}
                  />
                  <MultiSelect
                    className="atlas"
                    icon="pin"
                    isActive={view === LandPageView.ATLAS}
                    onClick={() => onSetView(LandPageView.ATLAS)}
                  />
                </Row>
              </Column>
            </Row>
