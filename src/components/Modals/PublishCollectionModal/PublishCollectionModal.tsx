...
import { ModalNavigation, Button, Mana, Loader, Field, InputOnChangeData, Form } from 'unicial-ui'
    ...
    return (
      <>
        ...
        <Modal.Content className="second-step">
          ...
          <a href="https://docs.unicial.org/wearables/publishing-wearables" rel="noopener noreferrer" target="_blank">
            {t('global.learn_more')}
          </a>
          ...
          <div className="tos">
            ...
            <p>
              <T
                ...
                values={{
                  terms_of_use: (
                    <a href="https://unicial.org/terms/" rel="noopener noreferrer" target="_blank">
                      {t('publish_collection_modal.terms_of_use')}
                    </a>
                  ),
                  content_policy: (
                    <a href="https://unicial.org/content/" rel="noopener noreferrer" target="_blank">
