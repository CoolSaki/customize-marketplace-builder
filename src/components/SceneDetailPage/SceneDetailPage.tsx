...
import { Page, Center, Loader, Section, Row, Narrow, Column, Header, Button, Dropdown, Icon, Empty } from 'unicial-ui'
      ...
      <>
        ...
        <Narrow>
          ...
          <Section className={project.description ? '' : 'no-margin-bottom'}>
            <Header sub className="scene-detail-subheader">
              {t('scene_detail_page.published_in')}
            </Header>
          ...
          {project.description ? (
            <Section className="description no-margin-bottom">
              <Header sub className="scene-detail-subheader">
                {t('scene_detail_page.description')}
              </Header>
